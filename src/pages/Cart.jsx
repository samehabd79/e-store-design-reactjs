    ...
    <div>
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between mt-4 mobile:flex-col">
          <button className="btn bg-white text-[#007AFF] hover:text-[#fff] border-2 border-[#007AFF] mt-0">
            Continue Shopping
          </button>
          <div className="flex text-lg hover:cursor-pointer mobile:m-5">
            <p className="border-2 border-[#007AFF] p-1 hover:bg-[#007ACC] hover:text-white rounded ">Items in your Cart: 3</p>
            <p className="border-2 border-[#007AFF] p-1 hover:bg-[#007ACC] hover:text-white rounded ml-5">Whishlist Items: 0</p>
          </div>
        ...
        <div className="flex flex-row mt-7 mobile:flex-col">
          ...
          <div className="Summary flex-[0.4] flex flex-col items-center w-auto h-[40vh] border-2 border-[#007AFF] rounded-md shadow-lg p-5 text-lg mobile:mb-6">
