...
const iconStyle = 'h-[40px] w-[40px] rounded-full bg-white flex items-center justify-center m-3 hover:bg-[#007AFF] hover:text-white hover:scale-[1.1] ease-in duration-100 cursor-pointer'
